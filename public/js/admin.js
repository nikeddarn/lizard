...
/***/ "./public/js/jquery.bootstrap-touchspin.js":
...
__webpack_require__("./vendor/snapappointments/bootstrap-select/js/bootstrap-select.js");

__webpack_require__("./public/js/jquery.bootstrap-touchspin.js");
//
// <!-- bootstrap-touchspin -->
...
/***/ "./vendor/snapappointments/bootstrap-select/js/bootstrap-select.js":
/***/ (function(module, exports) {
...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createLi: function createLi() {
       ...
       * @returns {HTMLElement}
       */
      var generateLI = function generateLI(content, classes, optgroup) {
      ...
      $selectOptions.each(function (index) {
        ...
        if (thisData.hidden === true || this.hidden || that.options.hideDisabled && (isDisabled || isOptgroupDisabled)) {
          ...
          if (showDivider && mainData[mainData.length - 1].type !== 'divider') {
            liIndex++;
            mainElements.push(generateLI(false, classNames.DIVIDER, optID + 'div'));
            mainData.push({
              type: 'divider',
              optID: optID
            });
...
module.exports = __webpack_require__("./resources/js/admin.js");
