...
class FullCartProducts extends AbstractCartProduct
{
    /**
    ...
    {
        $products = $user->cartProducts()->with('primaryImage', 'availableStorageProducts', 'expectingStorageProducts', 'availableVendorProducts', 'expectingVendorProducts')->get();
