...
class OrderUpdatedUserNotification extends Notification
{
    use Queueable;
    ...
    public function __construct(Order $order)
    {
        ...
        $this->settings = $settingsRepository->getProperty('notifications.order.updated');
    }
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(trans('shop.order.updated.subject'))
            ->markdown('mail.order.order_updated', [
