...
class OrderCreatedManagerNotification extends Notification
{
    use Queueable;
    ...
    public function __construct(Order $order)
    {
        ...
        $this->settings = $settingsRepository->getProperty('notifications.order.created');
    }
    ...
    public function toSms($notifiable)
    {
        ...
        $recipientPhone = $notifiable->routeNotificationForSms();
