...
class StoreCategoryRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'title_ru' => ['required', 'string', 'max:128', $this->createUniqueRule()],
            'title_ua' => ['required', 'string', 'max:128', $this->createUniqueRule()],
            'description_ru' => ['required', 'string', 'max:255', $this->createUniqueRule()],
            'description_ua' => ['required', 'string', 'max:255', $this->createUniqueRule()],
