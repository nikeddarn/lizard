                        ...
                        <div id="delivery-storage-wrapper"
                            ...
                            <select id="delivery-storage" name="storage_id" class="selectpicker w-100">
                                @foreach($storages as $storage)
                                    <option
                                        value="{{ $storage->id }}" {{ old('storage_id', $lastSelfDeliveryOrder ? $lastSelfDeliveryOrder->storages_id : null) == $storage->id ? ' selected="selected"' : '' }}>{{ $storage->city->name_ru }} - {{ $storage->name_ru }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
