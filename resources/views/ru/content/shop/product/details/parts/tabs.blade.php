<ul class="nav nav-tabs my-4" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link text-secondary" data-toggle="tab" href="#product-properties" role="tab" aria-controls="product-properties"
           aria-selected="false">Детали</a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-secondary" data-toggle="tab" href="#product-reviews" role="tab" aria-controls="product-reviews"
