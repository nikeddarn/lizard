    ...
    <div class="row form-group">
        ...
        <div class="col-md-8">
            <textarea id="title_ru" name="title_ru" type="text" class="w-100 p-1"
                      rows="3">{{ old('title_ru',  $pageData ? $pageData->title_ru : '') }}</textarea>
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-8">
            <textarea id="title_uk" name="title_uk" type="text" class="w-100 p-1"
                      rows="3">{{ old('title_ru', $pageData ? $pageData->title_uk : '') }}</textarea>
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-8">
            <textarea id="description_ru" name="description_ru" type="text" class="w-100 p-1"
                      rows="3">{{ old('description_ru', $pageData ? $pageData->description_ru : '') }}</textarea>
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-8">
            <textarea id="description_uk" name="description_uk" type="text" class="w-100 p-1"
                      rows="3">{{ old('description_uk', $pageData ? $pageData->description_uk : '') }}</textarea>
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-8">
            <textarea id="keywords_ru" name="keywords_ru" type="text" class="w-100 p-1"
                      rows="3">{{ old('keywords_ru', $pageData ? $pageData->keywords_ru : '') }}</textarea>
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-8">
            <textarea id="keywords_uk" name="keywords_uk" type="text" class="w-100 p-1"
                      rows="3">{{ old('keywords_uk', $pageData ? $pageData->keywords_uk : '') }}</textarea>
        </div>
    </div>
