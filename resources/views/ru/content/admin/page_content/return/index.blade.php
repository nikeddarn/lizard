...
@section('content')
    ...
    @include('content.admin.page_content.return.parts.header')
    ...
    <div class="card card-body">
        ...
        <form id="main-content-form" method="post"
              action="{{ route('admin.content.return.update') }}"
              role="form"
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link show active" data-toggle="tab"
                       href="#content-return-content" role="tab"
                       aria-controls="content-return-content"
                       aria-selected="true">Содержимое</a>

                    <a class="nav-item nav-link" data-toggle="tab"
                       href="#content-return-seo" role="tab"
                       aria-controls="content-return-seo"
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active"
                     id="content-return-content" role="tabpanel"
                     aria-labelledby="content-return-content-tab">
                    @include('content.admin.page_content.return.parts.content')
                </div>

                <div class="tab-pane fade"
                     id="content-return-seo" role="tabpanel"
                     aria-labelledby="content-return-seo-tab">
                    @include('content.admin.page_content.return.parts.seo')
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // activate admin menu
            let currentLink = $('#main-menu-content-return');
            ...
            $('.summernote').summernote({
                ...
                callbacks: {
                    onImageUpload: function (files) {
                        ...
                        $.post({
                            url: "{{ route('admin.content.return.upload.image') }}",
                            cache: false,
                            contentType: false,
                            processData: false,
                            data: data,
