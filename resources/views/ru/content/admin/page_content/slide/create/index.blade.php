...
@section('content')
    ...
    @include('content.admin.page_content.slide.create.parts.header')

    @include('elements.errors.admin_error.index')

    <div class="card card-body">

        <form id="slide-form" class="multitab-form" method="post" action="{{ route('admin.slider.slide.store') }}"
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="slide-image" role="tabpanel"
                    ...
                    @include('content.admin.page_content.slide.create.parts.images')
                </div>
                <div class="tab-pane fade" id="slide-title" role="tabpanel" aria-labelledby="slide-title-tab">
                    @include('content.admin.page_content.slide.create.parts.titles')
                </div>
                <div class="tab-pane fade" id="slide-link" role="tabpanel" aria-labelledby="slide-link-tab">
                    @include('content.admin.page_content.slide.create.parts.links')
                </div>
            </div>
