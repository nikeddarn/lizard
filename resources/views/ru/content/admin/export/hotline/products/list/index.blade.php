...
@section('content')
    ...
    @include('content.admin.export.hotline.products.list.parts.header')

    @if($products->count())
        <div class="card card-body my-4">
            @include('content.admin.export.hotline.products.list.parts.search')
        </div>

        <div class="card card-body">
            @include('content.admin.export.hotline.products.list.parts.product_form')
        </div>
    @endif
