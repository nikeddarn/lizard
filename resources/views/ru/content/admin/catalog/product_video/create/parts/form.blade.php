<form id="product-video-form" method="post" action="{{ route('admin.products.video.store') }}" role="form"
    ...
    <div class="text-right">
        <button type="submit" class="btn btn-primary">Сохранить видео</button>
    </div>
