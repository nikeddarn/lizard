...
@section('content')
    ...
    <div class="row admin-content-header">
        <div class="col admin-content-title"><h2>Изменить бренд:<i
                        class="ml-5 admin-content-sub-header">{{ $brand->name }}</i></h2></div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @include('content.admin.catalog.brand.update.parts.form')
