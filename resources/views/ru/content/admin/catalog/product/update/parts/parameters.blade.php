    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <div class="custom-control custom-radio custom-control-inline">
                <input class="custom-control-input" type="radio" name="is_new" id="newProductRadio" value="1" {{ old('is_new', $product->is_new) === 1 ? 'checked' : ''}}>
                <label class="custom-control-label" for="newProductRadio">Новый</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input class="custom-control-input" type="radio" name="is_new" id="secondHandProductRadio" value="0" {{ old('is_new', $product->is_new) === 0 ? 'checked' : ''}}>
...
<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="length" name="length" type="text" class="w-100" value="{{ old('length', $product->length) }}">
        </div>
    </div>
...
<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="width" name="width" type="text" class="w-100" value="{{ old('width', $product->width) }}">
        </div>
    </div>
...
<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="height" name="height" type="text" class="w-100" value="{{ old('height', $product->height) }}">
        </div>
    </div>
