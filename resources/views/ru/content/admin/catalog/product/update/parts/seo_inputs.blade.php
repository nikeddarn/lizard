<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="title_ua" name="title_ua" type="text" class="w-100" value="{{ old('title_ua', $product->title_ua) }}">
        </div>
    </div>
...
<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <textarea id="description_ua" name="description_ua" type="text" class="w-100" rows="3">{{ old('description_ua', $product->description_ua) }}</textarea>
        </div>
    </div>
