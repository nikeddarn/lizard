<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <textarea id="brief_content_ua" name="brief_content_ua" type="text" class="w-100 summernote" rows="6">{{ old('brief_content_ua', $product->brief_content_ua) }}</textarea>
        </div>
    </div>
...
<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <textarea id="content_ua" name="content_ua" type="text" class="w-100 summernote" rows="10">{{ old('content_ua', $product->content_ua) }}</textarea>
        </div>
    </div>
