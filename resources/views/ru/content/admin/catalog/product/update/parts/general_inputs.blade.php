<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="name_ru" name="name_ru" type="text" required class="w-100" value="{{ old('name_ru', $product->name_ru) }}">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="name_ua" name="name_ua" type="text" required class="w-100" value="{{ old('name_ua', $product->name_ua) }}">
        </div>
    </div>
...
<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="url" name="url" type="text" required class="w-100" placeholder="site.name/products/your-entering-url" value="{{ old('url', $product->url) }}">
        </div>
    </div>
