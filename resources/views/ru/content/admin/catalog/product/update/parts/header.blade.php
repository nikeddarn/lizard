<div class="card card-body mb-4">
    ...
    <div class="d-flex justify-content-between align-items-start">
        ...
        <h1 class="h4 text-gray-hover">
            <span class="d-none d-lg-inline">Редактировать продукт:</span>
            <span class="ml-4">{{ $product->name_ru }}</span>
        </h1>

        <div class="d-flex">
            <button type="submit" form="product-form" data-toggle="tooltip" title="Сохранить"
