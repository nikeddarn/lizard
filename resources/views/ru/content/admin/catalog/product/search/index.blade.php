...
@section('content')
    ...
    @include('content.admin.catalog.product.search.parts.header')

    @if($products->count())
        <div class="card card-body my-4">
            @include('content.admin.catalog.product.search.parts.search')
        </div>

        <div class="card card-body">
            @include('content.admin.catalog.product.search.parts.product_form')
        </div>
    @endif
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // activate admin menu
            let currentLink = $('#main-menu-catalog-products');
