<form id="attribute-form" method="post" action="{{ route('admin.attributes.update', ['id' => $attribute->id]) }}"
      role="form">
    ...
    <div class="card p-5 mb-5">
        ...
        <div class="row form-group">
            ...
            <div class="col-7 col-xl-8">
                <input id="name_ru" name="name_ru" type="text" required class="w-100"
                       value="{{ old('name_ru', $attribute->name_ru) }}">
            </div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-7 col-xl-8">
                <input id="name_uk" name="name_uk" type="text" required class="w-100"
                       value="{{ old('name_uk', $attribute->name_uk) }}">
            </div>
        </div>
        ...
        <div class="row form-group align-items-start align-items-lg-center">
            ...
            <div class="col-7 col-xl-10">
                <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="multiply_product_values">Разрешить присваивать несколько
                        значений атрибута одному продукту</label>
                </div>
            </div>
        </div>
            ...
            <div class="col-7 col-xl-10">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="indexable"
                           name="indexable" {{ (old('indexable', $attribute->indexable) ? 'checked' : '') }}>
                    <label class="custom-control-label" for="indexable">Разрешить роботу индексировать категорию при
                        применении фильтра с значением этого атрибута</label>
                </div>
            </div>
        </div>
