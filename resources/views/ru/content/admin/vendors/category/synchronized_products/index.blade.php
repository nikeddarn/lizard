...
@section('content')
    ...
    @include('content.admin.vendors.category.synchronized_products.parts.header')
    ...
    @if(!empty($vendorProcessingProducts))
        <div class="card card-body">
            @include('content.admin.vendors.category.synchronized_products.parts.product_list')
        </div>
