<header id="admin-header" class="container-fluid">
    ...
    <div class="row py-2">
        ...
        <div class="col-12 d-flex align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <span>Текущий курс:&nbsp;<strong>{{ $headerData['course'] }}</strong></span>
                <span class="ml-5">Баланс смс шлюза:&nbsp;<strong class="{{ $headerData['smsSenderBalance']['low_balance'] ? 'text-danger' : '' }}">{{ $headerData['smsSenderBalance']['value'] }}</strong></span>
            </div>
            <div>
