<div class="card card-pagination">
    <div class="card-body">
        ...
        @if($paginator->currentPage() === 1)
            <span class="btn btn-link btn-icon text-lizard" title="Попередня">
                <i class="svg-icon-larger" data-feather="chevron-left"></i>
            </span>
        @else
            <a href="{{ $paginator->previousPageUrl() }}" class="btn btn-link btn-icon text-lizard" title="Попередня">
                <i class="svg-icon-larger" data-feather="chevron-left"></i>
            </a>
        @endif
        ...
        @if($paginator->currentPage() === $paginator->lastPage())
            <span class="btn btn-link btn-icon text-lizard" title="Наступна">
                    <i class="svg-icon" data-feather="chevron-right"></i>
                </span>
        @else
            <a href="{{ $paginator->nextPageUrl() }}" class="btn btn-link btn-icon text-lizard" title="Наступна">
                <i class="svg-icon" data-feather="chevron-right"></i>
            </a>
        @endif
