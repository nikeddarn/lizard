        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('user.order.update') }}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title text-gray-hover" id="update-order-products-{{ $order->id }}-title">Зміна замовлення (id замовлення: <strong>{{ $order->id }}</strong>)</h5>
                        ...
                        @foreach($order->products as $product)
                            ...
                            <tr>
                                ...
                                <td class="d-table-cell cart-action nostretch pr-0">
                                    <button class="product-remove text-danger close" title="Видалити">
