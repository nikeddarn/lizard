        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('user.order.update') }}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title text-gray-hover" id="show-order-products-{{ $order->id }}-title">Список продуктів замовлення (id замовлення: <strong>{{ $order->id }}</strong>)</h5>
                        ...
                        @foreach($order->products as $product)
                            ...
                            <tr>
                                ...
                                <td class="d-inline-block d-md-table-cell cart-title">
                                    <a href="{{ route('shop.product.index', ['url' => $product->url, 'locale' => $locale,]) }}">
                                        <span class="text-gray-hover">{{ $product->name_uk }}</span>
                                    </a>
                                </td>
