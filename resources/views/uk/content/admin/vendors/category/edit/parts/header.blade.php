<div class="card card-body mb-4">
    ...
    <div class="d-flex justify-content-between">
        ...
        <h1 class="h4 text-gray-hover">
            <span>Редактировать категорию поставщика</span>
            <span class="ml-4">{{ $vendorCategory->vendor->name }}:</span>
            <span class="ml-2">{{ $vendorCategory->name }}</span>
        </h1>

        <div class="d-flex">

            <button type="submit" form="edit-category-form" data-toggle="tooltip"
