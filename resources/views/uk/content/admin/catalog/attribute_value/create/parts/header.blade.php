<div class="card card-body mb-4">
    ...
    <div class="d-flex justify-content-between">
        ...
        <h1 class="h4 text-gray-hover">Создать значение атрибута "{{ $attribute->name }}"</h1>
        ...
        <div class="d-flex">
            ...
            <a href="{{ route('admin.attributes.show', ['id' => $attribute->id]) }}" data-toggle="tooltip" title="Отменить"
