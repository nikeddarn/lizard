...
@section('content')
    ...
    <div class="card card-body my-4">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-item nav-link" data-toggle="tab" href="#product-video" role="tab"
                   aria-controls="product-video" aria-selected="false">Видео</a>
            </li>

            <li class="nav-item">
                <a class="nav-item nav-link" data-toggle="tab" href="#product-file" role="tab"
                   aria-controls="product-file" aria-selected="false">Файлы</a>
            </li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="product-video" role="tabpanel"
                ...
                @include('content.admin.catalog.product.show.parts.video')
            </div>

            <div class="tab-pane fade" id="product-file" role="tabpanel"
                 aria-labelledby="product-file-tab">
                @include('content.admin.catalog.product.show.parts.file')
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".product-video-delete-form").submit(function (event) {
                if (confirm('Удалить видео продукта ?')) {
                    return true;
                } else {
                    event.preventDefault();
                    return false;
            ...
            $(".product-file-delete-form").submit(function (event) {
                if (confirm('Удалить файл продукта ?')) {
                    return true;
                } else {
                    event.preventDefault();
                    return false;
