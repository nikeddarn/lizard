    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="name_uk" name="name_uk" type="text" required class="w-100"
                   value="{{ old('name_uk', $product->name_uk) }}">
        </div>
    </div>
...
<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="model_uk" name="model_uk" type="text" class="w-100" value="{{ old('model_uk', $product->model_uk) }}">
        </div>
    </div>
...
<div class="card p-5 mb-5">
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-8">
            <input id="manufacturer_uk" name="manufacturer_uk" type="text" class="w-100"
                   value="{{ old('manufacturer_uk', $product->manufacturer_uk) }}">
        </div>
    </div>
