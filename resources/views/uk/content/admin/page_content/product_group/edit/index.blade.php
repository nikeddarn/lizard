...
@section('content')
    ...
    @include('content.admin.page_content.product_group.edit.parts.header')

    @include('elements.errors.admin_error.index')

    <div class="card card-body">

        <form id="group-form" class="multitab-form" method="post" action="{{ route('admin.product.group.update') }}"
              role="form">
            @csrf
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="group-appearance" role="tabpanel"
                    ...
                    @include('content.admin.page_content.product_group.edit.parts.appearance')
                </div>
                <div class="tab-pane fade" id="group-products" role="tabpanel" aria-labelledby="group-products-tab">
                    @include('content.admin.page_content.product_group.edit.parts.products')
                </div>
            </div>
